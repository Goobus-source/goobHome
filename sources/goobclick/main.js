...
javascript:Game.LoadMod("./img/goob/autoclick.js");
javascript:Game.LoadMod("./img/goob/minute.js");
javascript:Game.LoadMod("./img/goob/badtothebone.js");
javascript:Game.LoadMod("./img/goob/stats.js");
javascript:Game.LoadMod("./img/goob/maxbutton.js");
javascript:Game.LoadMod("./img/goob/cookieper.js");
	...
	Game.Init=function()
	{
		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'</div>'+
				'<div id="statsGeneral">'+
					'<div class="listing"><b>'+loc("Goobuses in bank:")+'</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookies)+'</div></div>'+
					'<div class="listing"><b>'+loc("Goobuses baked (this ascension):")+'</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned)+'</div></div>'+
					'<div class="listing"><b>'+loc("Goobuses baked (all time):")+'</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned+Game.cookiesReset)+'</div></div>'+
					...
					'<div class="listing"><b>'+loc("goobus' per second:")+'</b> '+Beautify(Game.cookiesPs,1)+' <small>'+
						...
						'</small></div>'+
					'<div class="listing"><b>'+loc("Raw goobus per second:")+'</b> '+Beautify(Game.cookiesPsRaw,1)+' <small>'+
						'('+loc("highest this ascension:")+' '+Beautify(Game.cookiesPsRawHighest,1)+')'+
						'</small></div>'+
					'<div class="listing"><b>'+loc("Goobuses per click:")+'</b> '+Beautify(Game.computedMouseCps,1)+'</div>'+
					'<div class="listing"><b>'+loc("Goobus's clicks:")+'</b> '+Beautify(Game.cookieClicks)+'</div>'+
					'<div class="listing"><b>'+loc("Hand-made Goobuses")+'</b> '+Beautify(Game.handmadeCookies)+'</div>'+
